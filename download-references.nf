...
process hartwigmed {
  ...
  if( params.assembly == "GRCh37" )
    ...
    curl -o GRIDSS_PON_3792v1.hg19.zip "${params.hartwigGRIDSSURL}"
    unzip GRIDSS_PON_3792v1.hg19.zip
    cd GRIDSS && unzip GRIDSS_PON_3792v1.hg19.zip
